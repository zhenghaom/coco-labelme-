...
# 需要设置的路径
savepath="D:/tempdata/generate_xml/animal_with_person/" 
...
def check_image(coco, img_id, classes, classes_names):
    ...
    for ann in anns:
        ...
        if class_name == 'person':
            ...
            other_animals = True
            break
    return has_person and has_animal and not other_animals
...
# python C:\Users\郑浩铭\Desktop\file\1substract---xml--yes.py