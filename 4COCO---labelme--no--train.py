...
if __name__ == '__main__':
    #源目录                                                                  
    root_dir = 'D:/tempdata/generate_xml/animal_no_person/images/train_json'

    json_list = os.listdir(root_dir)
    #参考的json文件，因为labelme有部分固定的信息如版本等
    ...
    #目标路径
            json.dump(data_labelme,open('D:/tempdata/generate_xml/animal/labelme_train/%s.json' % file_name.split('.')[0],'w'),indent=4)  #000
