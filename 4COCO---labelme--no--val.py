...
#源目录
    root_dir = 'D:/tempdata/generate_xml/animal_no_person/images/val_json'
    ...
    for json_path in json_list:
        ...
        #目标路径
            json.dump(data_labelme,open('D:/tempdata/generate_xml/animal/labelme_val/%s.json' % file_name.split('.')[0],'w'),indent=4)  #000
#python C:\Users\郑浩铭\Desktop\file\4COCO---labelme--no--val.py