...
if __name__ == '__main__':
    #源目录
    root_dir = 'D:/tempdata/generate_xml/animal_with_person/images/train_json'
    ...
    #目标路径
            json.dump(data_labelme,open('D:/tempdata/generate_xml/animal_and_person/labelme_train/%s.json' % file_name.split('.')[0],'w'),indent=4) 
